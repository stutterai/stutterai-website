  ...
  return (
    <div className="footer-bg">
        ...
        <Row className="text-white">
          ...
          <Col xs={6} md={3}>
            <div className="single-footer-widget">
              ...
              <div className="widget-content">
                <NavLink className="footer-link">Stuttering Therapy</NavLink>
                <NavLink className="footer-link">Speech Evaluation</NavLink>
                <NavLink className="footer-link">Group Sessions</NavLink>
                <NavLink className="footer-link">Teletherapy</NavLink>
                <NavLink className="footer-link">Support Groups</NavLink>
              </div>
            </div>
          </Col>
          <Col xs={6} md={3}>
      ...
      <div className="footer-copy-right text-center text-white">
        <p className="mb-0">
          &copy; 2023 - <span className="developer">StutterAI</span> | All
          Rights Reserved
        </p>
      </div>
    </div>
