        ...
        <div className="head-bg">
            <Navbar className="navbar" collapseOnSelect expand="lg">
                <Container className="container-head">
                    <Navbar.Brand href="/home"><img src={logo} alt="logo"  style={{ width: 'auto', height: '70px' }}/></Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto align-items-center">
                            ...
                            <Link to="/chatbot" className='list-item text-decoration-none'>Chatbot</Link>
                            <Link to="/dashboard" className='list-item text-decoration-none'>Reports</Link>
